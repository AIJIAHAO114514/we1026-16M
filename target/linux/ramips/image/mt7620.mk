...
define Device/zbtlink_zbt-we1026-16m
  SOC := mt7620a
  IMAGE_SIZE := 16064k
  DEVICE_VENDOR := Zbtlink
  DEVICE_MODEL := ZBT-WE1026
  DEVICE_VARIANT := 16M
  DEVICE_PACKAGES := kmod-usb2 kmod-usb-ohci kmod-mmc-mtk uqmi \
	-kmod-rt2800-soc -wpad-basic-mbedtls -iwinfo
  SUPPORTED_DEVICES += zbt-we1026 we1026-16m zbtlink,zbt-we1026-16m
endef
TARGET_DEVICES += zbtlink_zbt-we1026-16m
